...
public class Chest extends TileEntity implements IInventory
{
    private ItemStack[] chestContents = new ItemStack[52];
    /** Determines if the check for adjacent chests has taken place. */
    public boolean adjacentChestChecked;
    /** Contains the chest tile located adjacent to this one (if any) */
    public Chest adjacentChestZNeg;
    /** Contains the chest tile located adjacent to this one (if any) */
    public Chest adjacentChestXPos;
    /** Contains the chest tile located adjacent to this one (if any) */
    public Chest adjacentChestXNeg;
    /** Contains the chest tile located adjacent to this one (if any) */
    public Chest adjacentChestZPos;
    ...
    private void func_145978_a(Chest p_145978_1_, int p_145978_2_)
    {
    ...
    public void checkForAdjacentChests()
    {
        if (!this.adjacentChestChecked)
        {
            ...
            {
                this.adjacentChestXNeg = (Chest)this.worldObj.getTileEntity(this.xCoord - 1, this.yCoord, this.zCoord);
            }

            if (this.func_145977_a(this.xCoord + 1, this.yCoord, this.zCoord))
            {
                this.adjacentChestXPos = (Chest)this.worldObj.getTileEntity(this.xCoord + 1, this.yCoord, this.zCoord);
            }

            if (this.func_145977_a(this.xCoord, this.yCoord, this.zCoord - 1))
            {
                this.adjacentChestZNeg = (Chest)this.worldObj.getTileEntity(this.xCoord, this.yCoord, this.zCoord - 1);
            }

            if (this.func_145977_a(this.xCoord, this.yCoord, this.zCoord + 1))
            {
                this.adjacentChestZPos = (Chest)this.worldObj.getTileEntity(this.xCoord, this.yCoord, this.zCoord + 1);
            }
