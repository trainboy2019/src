...
import com.camp.tile_entity.TileEntityAlabasterOven;
...
public class AlabasterOven extends BlockContainer {
	...
	public void registerBlockIcons(IIconRegister iconRegister) {
		...
		this.iconFront = iconRegister.registerIcon(StringLibrary.MODID + ":" + (this.isActive ? "AlabasterOvenFrontOn" : "AlabasterOvenFrontOff"));
	...
	public Item getItemDropped(int i, Random random, int j) {
		return Item.getItemFromBlock(BlockManager.blockAlabasterOvenIdle);
	}
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitX, float hitY, float hitZ) {
		if(!world.isRemote) {
			FMLNetworkHandler.openGui(player, MainRegistry.instance, BlockManager.guiIDAlabasterOven, world, x, y, z);
		}
		return true;
	}
	...
	public static void updateAlabasterOvenBlockState(boolean active, World worldObj, int xCoord, int yCoord, int zCoord) {
		...
		if(active) {
			worldObj.setBlock(xCoord, yCoord, zCoord, BlockManager.blockAlabasterOvenActive);
		}else{
			worldObj.setBlock(xCoord, yCoord, zCoord, BlockManager.blockAlabasterOvenIdle);
		}
