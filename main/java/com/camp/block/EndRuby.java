...
public class EndRuby extends Block {
	...
	protected EndRuby(String unlocalizedName, Material mat, Item drop, int meta, int least_quantity, int most_quantity) {
		super(mat);
		this.drop = drop;
		this.meta = meta;
		...
		this.setBlockTextureName(StringLibrary.MODID + ":" + "end_ruby");
	...
	protected EndRuby(String unlocalizedName, Material mat, Item drop, int least_quantity, int most_quantity) {
		this(unlocalizedName, mat, drop, 0, least_quantity, most_quantity);
	}

	protected EndRuby(String unlocalizedName, Material mat, Item drop) {
