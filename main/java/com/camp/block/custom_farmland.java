...
public class custom_farmland extends Block
{
   ...
   // @SideOnly(Side.CLIENT)
	...
	public void registerBlockIcons1(IIconRegister iconReg) {
	    for(int i = 0; i < iconArray.length; i++) {
	        iconArray[i] = iconReg.registerIcon(StringLibrary.MODID + ":custom_farmland_" + i);
	    }
	}
    ...
    protected custom_farmland(Material ice)
    {
        super(Material.ice);
        ...
        //this.setBlockTextureName(p_149658_1_)
    }
   ...
   // {
    ...
    public void updateTick(World p_149674_1_, int p_149674_2_, int p_149674_3_, int p_149674_4_, Random p_149674_5_)
    {
        if (!this.func_149821_m(p_149674_1_, p_149674_2_, p_149674_3_, p_149674_4_) && !p_149674_1_.canLightningStrikeAt(p_149674_2_, p_149674_3_ + 1, p_149674_4_))
        {
            ...
            {
                p_149674_1_.setBlock(p_149674_2_, p_149674_3_, p_149674_4_, Blocks.packed_ice);
            }
        }
        else
        {
    ...
    public void onFallenUpon(World p_149746_1_, int p_149746_2_, int p_149746_3_, int p_149746_4_, Entity p_149746_5_, float p_149746_6_)
    {
        if (!p_149746_1_.isRemote && p_149746_1_.rand.nextFloat() < p_149746_6_ - 0.5F)
        {
            ...
            p_149746_1_.setBlock(p_149746_2_, p_149746_3_, p_149746_4_, Blocks.packed_ice);
        }
    }
    ...
    public void onNeighborBlockChange(World p_149695_1_, int p_149695_2_, int p_149695_3_, int p_149695_4_, Block p_149695_5_)
    {
        ...
        if (material.isSolid())
        {
            p_149695_1_.setBlock(p_149695_2_, p_149695_3_, p_149695_4_, Blocks.packed_ice);
        }
    }

    public Item getItemDropped(int p_149650_1_, Random p_149650_2_, int p_149650_3_)
    {
        return Blocks.packed_ice.getItemDropped(0, p_149650_2_, p_149650_3_);
    }
    ...
    {
        this.blockIcon = p_149651_1_.registerIcon(this.getTextureName() + "_wet");
        this.blockIcon = p_149651_1_.registerIcon(this.getTextureName() + "_dry");
    }
}*/