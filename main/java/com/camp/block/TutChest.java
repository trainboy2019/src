...
import com.camp.tile_entity.TileEntityTutChest;

import cpw.mods.fml.relauncher.Side;
import cpw.mods.fml.relauncher.SideOnly;

public class TutChest extends BlockChest {

	private final Random field_149955_b = new Random();
	
	protected TutChest(int p_i45397_1_) {
		super(p_i45397_1_);
    ...
    public void onBlockPlacedBy(World p_149689_1_, int p_149689_2_, int p_149689_3_, int p_149689_4_, EntityLivingBase p_149689_5_, ItemStack p_149689_6_)
    {
        ...
        {
            ((TileEntityTutChest)p_149689_1_.getTileEntity(p_149689_2_, p_149689_3_, p_149689_4_)).func_145976_a(p_149689_6_.getDisplayName());
        }
    }
    ...
    public void onNeighborBlockChange(World p_149695_1_, int p_149695_2_, int p_149695_3_, int p_149695_4_, Block p_149695_5_)
    {
        ...
        TileEntityTutChest tileentitychest = (TileEntityTutChest)p_149695_1_.getTileEntity(p_149695_2_, p_149695_3_, p_149695_4_);
    ...
    {
        TileEntityTutChest tileentitychest = (TileEntityTutChest)p_149749_1_.getTileEntity(p_149749_2_, p_149749_3_, p_149749_4_);
    ...
    {
        Object object = (TileEntityTutChest)p_149951_1_.getTileEntity(p_149951_2_, p_149951_3_, p_149951_4_);
        ...
        else
        {
            ...
            {
                object = new InventoryLargeChest("Large Tut Chest", (TileEntityTutChest)p_149951_1_.getTileEntity(p_149951_2_ - 1, p_149951_3_, p_149951_4_), (IInventory)object);
            }

            if (p_149951_1_.getBlock(p_149951_2_ + 1, p_149951_3_, p_149951_4_) == this)
            {
                object = new InventoryLargeChest("Large Tut Chest", (IInventory)object, (TileEntityTutChest)p_149951_1_.getTileEntity(p_149951_2_ + 1, p_149951_3_, p_149951_4_));
            }

            if (p_149951_1_.getBlock(p_149951_2_, p_149951_3_, p_149951_4_ - 1) == this)
            {
                object = new InventoryLargeChest("Large Tut Chest", (TileEntityTutChest)p_149951_1_.getTileEntity(p_149951_2_, p_149951_3_, p_149951_4_ - 1), (IInventory)object);
            }

            if (p_149951_1_.getBlock(p_149951_2_, p_149951_3_, p_149951_4_ + 1) == this)
            {
                object = new InventoryLargeChest("Large Tut Chest", (IInventory)object, (TileEntityTutChest)p_149951_1_.getTileEntity(p_149951_2_, p_149951_3_, p_149951_4_ + 1));
            }
    ...
    {
        TileEntityTutChest tileentitychest = new TileEntityTutChest();
    ...
    {
        this.blockIcon = p_149651_1_.registerIcon(StringLibrary.MODID + ":TutChest");
    }
