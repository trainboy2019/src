...
import com.camp.block.sapphireChest;
...
public class RenderSapphireChest extends TileEntitySpecialRenderer
{
    private static final ResourceLocation field_147505_d = new ResourceLocation(StringLibrary.MODID + ":textures/blocks/LargePupletChest");
    private static final ResourceLocation field_147504_g = new ResourceLocation(StringLibrary.MODID + ":textures/blocks/PupletChest");
    private ModelChest field_147510_h = new ModelChest();
    private ModelChest field_147511_i = new ModelLargeChest();
    private boolean field_147509_j;
    private static final String __OBFID = "CL_00000965";

    public RenderSapphireChest()
    {
